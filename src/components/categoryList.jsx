                        ...
                        >
                            ...
                            <div className="flex-1 flex items-center justify-between min-w-0">
                                <div className="min-w-0">
                                    ...
                                    <h5 className="font-medium text-sm text-gray-900 truncate capitalize">{category.name}</h5>
                                    <span className={`text-xs font-medium px-2 py-0.5 rounded-full capitalize ${category.type?.toLowerCase() === "income"
